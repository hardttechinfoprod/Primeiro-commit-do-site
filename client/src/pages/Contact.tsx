      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="container flex items-center justify-between py-4">
          ...
          <nav className="hidden lg:flex items-center gap-0">
            ...
            <Link href="/contato" className="px-4 py-2 text-sm font-semibold uppercase tracking-wide text-[#C79C74] border-b-2 border-[#C79C74]">Contato</Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <MapPin className="text-[#C79C74] flex-shrink-0" size={24} />
                  <div>
                ...
                <div className="flex gap-4">
                  <Phone className="text-[#C79C74] flex-shrink-0" size={24} />
                  <div>
                ...
                <div className="flex gap-4">
                  <Mail className="text-[#C79C74] flex-shrink-0" size={24} />
                  <div>
            ...
            <div className="lg:col-span-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input name="name" value={formData.name} onChange={handleChange} type="text" placeholder="Nome Completo *" className="px-4 py-3 border border-gray-300 text-sm focus:outline-none focus:border-[#C79C74]" required />
                  <input name="email" value={formData.email} onChange={handleChange} type="email" placeholder="Email *" className="px-4 py-3 border border-gray-300 text-sm focus:outline-none focus:border-[#C79C74]" required />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input name="phone" value={formData.phone} onChange={handleChange} type="tel" placeholder="Telefone" className="px-4 py-3 border border-gray-300 text-sm focus:outline-none focus:border-[#C79C74]" />
                  <select name="subject" value={formData.subject} onChange={handleChange} className="px-4 py-3 border border-gray-300 text-sm text-gray-500 focus:outline-none focus:border-[#C79C74]">
                ...
                <textarea name="message" value={formData.message} onChange={handleChange} rows={6} placeholder="Sua mensagem *" className="w-full px-4 py-3 border border-gray-300 text-sm focus:outline-none focus:border-[#C79C74] resize-none" required />
                <button type="submit" className="px-8 py-3 bg-[#C79C74] text-white font-semibold uppercase text-sm hover:bg-[#b8976a] transition-colors flex items-center gap-2">
